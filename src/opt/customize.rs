use super::*;
impl OptArray {
    pub fn get_sig_from_doc(&self) -> (HashMap<String, CallFn>, HashSet<String>, HashSet<String>) {
        ...
        parse_doc_with_root_file(&source_rust_content)
    }
}
